...
@section('konten')
						...
						<div class="col-md-8">
							...
							<div class="panel panel-headline">
								...
								<div class="panel-body">
                                    ...
                                    <a href="/penilaian" class="card-link">Kembali</a>
								</div>
							</div>
									...
									<table class="table">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<a href="#" class="nilai" data-type="text" data-pk="{{$penilaian->id}}" data-url="/api/detail/{{$student->id}}/editnilai" data-title="Masukkan Nilai">{{$penilaian->pivot->nilai}}</a>
												</td>
												<td>
													<a href="/detail/{{$student->id}}/{{$penilaian->id}}/deletenilai" class="btn btn-danger">Delete</a>
												</td>
											</tr>
											@endforeach
										</tbody>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	  ...
	  <form action="/detail/{{$student->id}}/addnilai" method="post" > 
		@csrf
		<div class="form-group">
			<label for="penilaian">Jenis Penilaian</label>
