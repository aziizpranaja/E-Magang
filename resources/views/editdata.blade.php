	...
	<h1>Form Ubah Data</h1>
		...
		@csrf
			...
			<div class="mb-3">
				  ...
				  <input type="text" class="form-control @error('nama_perusahaan') is-invalid @enderror" id="nim" placeholder="Masukkan Perusahaan" name="nama_perusahaan"  value="{{ $student->nama_perusahaan}}" >
			...
			<div class="mb-3">
				  ...
				  <input type="text" class="form-control  @error('lokasi_magang') is-invalid @enderror" id="lokasi_magang" placeholder="Masukkan Lokasi Magang" name="lokasi_magang"  value="{{ $student->lokasi_magang}}">
				  @error('lokasi_magang')
				  <div id="validationServerUsernameFeedback" class="invalid-feedback">
        				{{$message}}
      			  </div>
