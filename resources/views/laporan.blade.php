			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="/laporan" class="active"><i class="lnr lnr-license"></i> <span>Laporan</span></a></li>
			...
			<div class="main-content">
                ...
                <form action="/laporan" method="post"  enctype="multipart/form-data" > 
                    @csrf
                        ...
                        <input type="file" class="form-control @error('laporan') is-invalid @enderror" id="laporan" name="laporan" >
						@error('laporan')
                            <div id="validationServerUsernameFeedback" class="invalid-feedback">
                                    {{$message}}
                            </div>
