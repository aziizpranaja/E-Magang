			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="filter-data" class="active"><i class="lnr lnr-lighter"></i> <span>Absensi Mahasiswa</span></a></li>
				...
				<div class="container-fluid">
                    ...
                    <div class="card card-info card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <a href="" onclick="this.href='/filter-data/'+ document.getElementById('tglawal').value " class="btn btn-primary col-md-12">
