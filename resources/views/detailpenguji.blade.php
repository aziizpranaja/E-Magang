...
@section('konten')
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="/penilaianpembimbing" class="active"><i class="lnr lnr-code"></i> <span>Penilaian</span></a></li>
						...
						<li><a href="elements.html" class="active"><i class="lnr lnr-book"></i><span>Penilaian</span></a></li>
						@endif
						...
						<div class="col-md-8">
							...
							<div class="panel panel-headline">
								...
								<div class="panel-body">
                                    ...
                                    <a href="/penilaianpenguji" class="card-link">Kembali</a>
								</div>
							</div>
									...
									<table class="table">
										...
										<tbody>
											...
											<tr>
												...
												<td>{{$penguji->nama}}</td>
												<td>
													<a href="#" class="nilai" data-type="text" data-pk="{{$penguji->id}}" data-url="/api/detailpenguji/{{$student->id}}/editnilai" data-title="Masukkan Nilai">{{$penguji->pivot->nilai}}</a>
												</td>
												<td>
													<a href="/detailpenguji/{{$student->id}}/{{$penguji->id}}/deletenilai" class="btn btn-danger">Delete</a>
												</td>
											</tr>
											@endforeach
										</tbody>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	  ...
	  <form action="/detailpenguji/{{$student->id}}/addnilai" method="post" > 
		@csrf
		<div class="form-group">
			<label for="penguji">Jenis Penilaian</label>
